        ...
        <Wrapper>
            <Link href={`/`}>
                <a>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <path d="M20.05 6.81774L14.29 2.78774C12.72 1.68774 10.31 1.74774 8.8 2.91774L3.79 6.82774C2.79 7.60774 2 9.20774 2 10.4677V17.3677C2 19.9177 4.07 21.9977 6.62 21.9977H17.4C19.95 21.9977 22.02 19.9277 22.02 17.3777V10.5977C22.02 9.24774 21.15 7.58774 20.05 6.81774ZM12.76 17.9977C12.76 18.4077 12.42 18.7477 12.01 18.7477C11.6 18.7477 11.26 18.4077 11.26 17.9977V14.9977C11.26 14.5877 11.6 14.2477 12.01 14.2477C12.42 14.2477 12.76 14.5877 12.76 14.9977V17.9977Z" fill="#06161C"/>
                    </svg>
                </a>
            </Link>
            <Link href={`/products`}>
                <a>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <rect width="24" height="24" fill="white"/>
                        <path d="M7.24 2H5.34C3.15 2 2 3.15 2 5.33V7.23C2 9.41 3.15 10.56 5.33 10.56H7.23C9.41 10.56 10.56 9.41 10.56 7.23V5.33C10.57 3.15 9.42 2 7.24 2Z" fill="#DBDBDB"/>
                        <path d="M18.6699 2H16.7699C14.5899 2 13.4399 3.15 13.4399 5.33V7.23C13.4399 9.41 14.5899 10.56 16.7699 10.56H18.6699C20.8499 10.56 21.9999 9.41 21.9999 7.23V5.33C21.9999 3.15 20.8499 2 18.6699 2Z" fill="#DBDBDB"/>
                        <path d="M18.6699 13.43H16.7699C14.5899 13.43 13.4399 14.58 13.4399 16.76V18.66C13.4399 20.84 14.5899 21.99 16.7699 21.99H18.6699C20.8499 21.99 21.9999 20.84 21.9999 18.66V16.76C21.9999 14.58 20.8499 13.43 18.6699 13.43Z" fill="#DBDBDB"/>
                        <path d="M7.24 13.43H5.34C3.15 13.43 2 14.58 2 16.76V18.66C2 20.85 3.15 22 5.33 22H7.23C9.41 22 10.56 20.85 10.56 18.67V16.77C10.57 14.58 9.42 13.43 7.24 13.43Z" fill="#DBDBDB"/>
                    </svg>
                </a>
            </Link>
            <Link href={`#`}>
            ...
            <Link href={`#`}>
                <a>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <rect width="24" height="24" fill="white"/>
                        <path d="M12.09 12C14.8514 12 17.09 9.76142 17.09 7C17.09 4.23858 14.8514 2 12.09 2C9.32854 2 7.08997 4.23858 7.08997 7C7.08997 9.76142 9.32854 12 12.09 12Z" fill="#DBDBDB"/>
                        <path d="M12.09 14.5C7.08 14.5 3 17.86 3 22C3 22.28 3.22 22.5 3.5 22.5H20.68C20.96 22.5 21.18 22.28 21.18 22C21.18 17.86 17.1 14.5 12.09 14.5Z" fill="#DBDBDB"/>
                    </svg>
                </a>
            </Link>
        </Wrapper>
